...
def restaurant():
    ...
    if 'username' not in login_session:
        return render_template('publicrestaurants.html', restaurants=restaurant)
    return render_template(
        'restaurant.html', restaurants=restaurant)

# New restaurant adder link
...
def restaurantMenu(restaurant_id):
    ...
    if 'username' not in login_session or creator.id != login_session['user_id']:
        return render_template(
        'publicmenu.html', restaurant=restaurant, items=items, restaurant_id=restaurant_id, creator=creator, s=login_session)
    return render_template(
        'menu.html', restaurant=restaurant, items=items, restaurant_id=restaurant_id, creator=creator)

# New menu item adder link
